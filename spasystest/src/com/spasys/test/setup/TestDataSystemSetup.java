...
import com.spasys.test.constants.SpasysTestConstants;
import com.spasys.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SpasysTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/spasystest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/spasystest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/spasystest/import/cstickets.impex");
			...
			importImpexFile(context, "/spasystest/import/csquotes.impex");
		}
	}
}
