...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/spasysstorefront/electronics/en",
						"https://electronics.local:9002/spasysstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/spasysstorefront/electronics/en",
						"https://electronics.local:9002/spasysstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/spasysstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/spasysstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/spasysstorefront/electronics/en",
						"https://electronics.local:9002/spasysstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/spasysstorefront",
						"https://electronics.local:9002/spasysstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/spasysstorefront",
						"https://electronics.local:9002/spasysstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/spasysstorefront/electronics/en",
						"https://electronics.local:9002/spasysstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
